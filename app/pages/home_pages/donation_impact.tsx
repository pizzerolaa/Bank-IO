    ...
    <ScrollView style={styles.container}>
      ...
      <Card style={styles.card}>
        <Card.Content>
          ...
          <Paragraph>
            Gracias a tus donaciones, has ayudado a combatir la inseguridad
            alimentaria en {impactData.communitiesReached} comunidades
            diferentes. Tus contribuciones han proporcionado alimentos
            nutritivos a {impactData.totalBeneficiaries} personas necesitadas,
            marcando una diferencia significativa en sus vidas. Cada kilogramo
            de alimento que donas se traduce en esperanza y bienestar para estas
            comunidades. ¡Sigue haciendo la diferencia!
          </Paragraph>
        </Card.Content>
      </Card>
    </ScrollView>
