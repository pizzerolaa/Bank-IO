...
function DonationConf({ navigation }) {
    ...
    return(
        <View style={styles.container}>
            ...
            <Text style={styles.text}>{"\n"}Gracias por tu donación. Tu ayuda es muy valiosa para nosotros.</Text>
            <Text style={styles.text}>Tu código QR para esta donación es:</Text>
            {renderQR()}
            <Text style={styles.text}>Preséntalo en el lugar de recolección para completar la donación.</Text>
